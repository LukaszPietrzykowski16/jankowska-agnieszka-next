...
function Fizjo() {
    return (
        ...
        <div className='about-text'>
          <h1> Cześć! </h1>
          <p className='pad'> Nazywam się Agnieszka Jankowska i jestem magistrem fizjoterapii. Ukończyłam Uniwersytet Medyczny w Łodzi na tym kierunku, ale zawodowo jestem związana ze Zduńską Wolą. Po zakończeniu studiów w dalszym ciągu zdobywam wiedzę na licznych szkoleniach. (<a href='#carousel'>Zobacz tutaj </a>) </p> 
